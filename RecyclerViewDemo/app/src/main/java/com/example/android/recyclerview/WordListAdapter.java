...
public class WordListAdapter
    ...
    public final List<Grocery> groceries;
    ...
    class WordViewHolder extends RecyclerView.ViewHolder
        ...
        public WordViewHolder(final View itemView, WordListAdapter adapter) {
            ...
            // Product Name
            wordItemView = (TextView) itemView.findViewById(R.id.Name);
            // Product Image
            productImage = (ImageView) itemView.findViewById(R.id.productImage);
            // Product Price
            productPrice = (TextView) itemView.findViewById(R.id.Value);
            // Product Weight
            productWeight = (TextView) itemView.findViewById(R.id.weight);
            // Product QTY
    ...
    public WordListAdapter(Context context, List<Grocery> groceries) {
    ...
    public void onBindViewHolder(WordViewHolder holder, int position) {
        ...
        holder.wordItemView.setText(groceries.get(position).productName);
        holder.productImage.setImageResource(groceries.get(position).productImage);
        holder.productPrice.setText(groceries.get(position).getProductPrice());
        holder.productWeight.setText(groceries.get(position).getProductWeight());
        holder.productQty.setText(groceries.get(position).getProductQty());
